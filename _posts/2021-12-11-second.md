...
```python
## Input layer to the first layer(Using sigmoid function as an activation function)
```
...
```python
## First layer to the second layer(Using sigmoid function as an activation function)
```
